package com.ksq.core.common.constant;
...
public class Constant {
    ...
    public final static String SALE_ROLE_NORMAL = "ROLE_MGR_NORMAL"; 	    // 正常
    ...
    public static final String MANUAL_CONTROLLER_ROOT_PATH = "/api";
